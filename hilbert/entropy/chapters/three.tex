...
\section{The Physical Impossibility of Spline Necessity}
\label{subsec:impossibility-spline-law}

A law of spline necessity \emph{would} describe the continuous limit of an
ideal refinement process. In such a limit, where arbitrarily fine
...
\begin{phenomenon}[Informational Viscosity of Quicksand~\cite{batchelor1967,bonn2005}]
