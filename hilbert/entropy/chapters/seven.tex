...
\begin{phenomenon}[The Cost of Broken Symmetry]
When a ledger maintains an internal phase that does not align with the
propagation of admissible refinements, a persistent bookkeeping cost is
incurred.  This cost appears as inertia.

Mass is therefore not substance, but the energetic price of maintaining a
misaligned refinement phase in a globally consistent record.
\end{phenomenon}


\section{Merging at the Boundaries}
\begin{phenomenon}[The Holographic Effect]
The interior of an admissible region contains no independent informational
content.  The ledger changes only at the boundary.  All admissible interior
structure is fixed by the reconciliation of boundary refinements.

The maximum number of distinguishable states therefore scales with the size
of the boundary ledger, not the volume enclosed.  The interior is a smooth
shadow of boundary bookkeeping.
\end{phenomenon}
...
\textbf{Conclusion.}
Chirality is the failure of mirror symmetry in the causal ledger.  It is the
record of an orientation choice that cannot be erased by smoothing or
averaging.
\end{phenomenon}


\textbf{There is no higher--order arena in which to postulate measurable effects.}
