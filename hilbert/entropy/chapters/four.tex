...
\begin{proposition}[Anti–symmetry]
\label{prop:antisym}
...
\begin{proposition}[Commutativity $\Rightarrow$ relativistic simultaneity]
...
Sections~\ref{sec:heat-conduction}--\ref{sec:heat-advection}, radiation is
