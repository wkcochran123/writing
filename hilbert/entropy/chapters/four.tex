...
\begin{definition}[Martin’s Condition]
...
\begin{phenomenon}[Entanglement~\cite{einstein1935}]
...
\begin{phenomenon}[Mach--Zehnder Interferometer~\cite{zehnder1891}]
...
\begin{phenomenon}[Bell--Aspect Tests~\cite{bell1964}]
...
\section{Informational Phenomenon: Qubit Decoherence}
...
\begin{definition}[Prediction~\cite{einstein1915,hamilton1834,hilbert1924,lagrange1788,maxwell1865,newton1687,schroedinger1926} et alii plures]\label{def:prediction}
...
\textbf{This definition closes the Hilbertian foundation of the theory.  With 
prediction identified as the inverse update $\Psi^{-1}$, the list of primitive 
notions is complete in the sense of Hilbert's program~\cite{hilbert1922}.  
No further assumptions will be introduced.  The remainder of the physical 
apparatus will now be derived from these primitives alone.}
