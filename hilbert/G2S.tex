...
\usepackage{enumitem} % enumerate formatting
\onehalfspacing
...
\providecommand{\Hspace}{H^2(\Domain)}
...
Let \(\Hspace = H^2(\Domain)\) with natural boundary conditions. Define
\[
  \Bform(W,V) := \int_{\Domain} W''\, V'' \, dx \qquad (W,V \in \Hspace).
\]
Then \(\Bform\) is symmetric and positive (semi)definite. The weak form reads: find \(\U\in\Hspace\) such that
\[
  \Bform(\U,\ph) = 0 \quad \forall\, \ph \in \Hspace .
\]
\end{definition}
...
\begin{varobligation}
  \item \textbf{Reciprocity and coercivity.} The bilinear form \(\Bform(\U,\ph)\) is symmetric. Coercivity holds by a Poincaré–type inequality on \(H^2(\Domain)\) under the imposed boundary conditions.
