...
\large Validating G4: Boundary Terms and Sign Convention}
...
The system seeks minimal informational curvature, defined by the functional $\mathcal{R}[\U]$. The core principle of Reciprocity (Module 1, G5) requires that every variation $\delta \mathcal{R}$ must correspond to a measurable distinction $\Phi$. The canonical closure is achieved when the first variation vanishes, $\delta \mathcal{R} = 0$.
...
\begin{center}
\textit{Conclusion for G4: The Reciprocity Law closes exactly at the boundaries of observation.}
\end{center}
