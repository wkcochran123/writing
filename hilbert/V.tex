...
\newcommand{\g}{g}                      % Metric (components g_{\mu\nu} inline)
...
\centering Kinematics $(U^{(4)}=0)$ & $\leftrightarrow$ & \centering Global Consistency (Event Selection / MA-like)\\
...
\begin{theorem}[Second Law of Causal Order]\label{thm:DeltaS}
